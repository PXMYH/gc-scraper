...
for year in range(start_year, current_year + 1):
    for month_index, month in enumerate(months):
        ...
        if response.status_code == 200:
            ...
            section_selector = "body > div.tsg-rwd-body-frame-row > div.contentbody > div.tsg-rwd-main-copy-frame > div.tsg-rwd-main-copy-body-frame.withrail > div.tsg-rwd-content-page-parsysxxx.parsys > div:nth-child(5) > div"
            employment_based_element = soup.css.select(section_selector)
            print(f"employment_based_element = {employment_based_element}")
